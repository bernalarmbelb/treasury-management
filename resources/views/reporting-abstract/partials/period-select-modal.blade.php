...
<div class="form-batch-modal-overlay" id="ramPeriodModalOverlay">
    <div class="form-batch-modal ram-period-modal">
        <div class="form-batch-modal-header">
            <button type="button" class="form-batch-close-btn" id="ramPeriodModalCloseBtn" aria-label="Close">
                <x-bx-x class="icon" />
            </button>
        </div>

        <h2 class="form-batch-modal-title" id="ramPeriodModalTitle">Generate Report</h2>
        <p class="orabf-export-subtitle">Select a date range for the report.</p>
        <div class="orabf-export-divider"></div>

        <form id="ramPeriodForm">
            ...
            <div class="form-batch-actions">
                <button type="submit" class="form-batch-save-btn">
                    Generate
                </button>
            </div>
        </form>
