    ...
    <div class="collection-content">
        <form class="ctc-page" id="ctcForm" method="POST" action="{{ route('transaction-entry.individual-cedula.store', $form->id, false) }}">
            ...
            <div class="ctc-field ctc-cert-no" style="left:650px; top:40px; width:272px; height:58px;">
                <input type="text" class="ctc-cert-no-prefix-input" id="ctc-cert-prefix" name="certificate_prefix" value="CCI2022">
                <input type="text" class="ctc-cert-no-input" id="ctc-cert-no" name="certificate_number" value="13476955">
            </div>
