    ...
    <div class="form-batch-modal um-modal-card">
        ...
        <form id="resetPasswordVerifyForm" method="POST" action="">
            ...
            <div class="form-batch-field-group">
                ...
                <div class="form-batch-password-wrap">
                    <input type="password" id="resetVerifyPasswordInput" name="password" class="form-batch-input form-batch-input-full" placeholder="Password" required>
                    <button type="button" class="form-batch-eye-btn" data-toggle-password="resetVerifyPasswordInput" aria-label="Show password">
