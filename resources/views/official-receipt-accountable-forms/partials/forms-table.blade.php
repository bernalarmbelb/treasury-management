                ...
                <tr>
                    ...
                    <td class="col-actions">
                        <div class="table-actions">
                            ...
                            <button type="button" class="action-btn action-batch js-add-batch" data-form-stock-id="{{ $form->id }}" data-form-code="{{ $form->form_code }}" aria-label="Add New Batch">Add New Batch</button>
